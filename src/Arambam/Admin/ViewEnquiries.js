...
const ViewEnquiries = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://arambam-server.onrender.com/enquiries`)
      .then((res) => setEnq(res.data))
      .catch((err) => console.log(err));
  });
  const deleteEnq = (enqId) => {
    axios
      .delete(`https://arambam-server.onrender.com/enquiries/${enqId}`)
      .then(() => alert("Your Selected Enquiry was Deleted"))
      .catch((err) => console.log(err));
  };
  const getOneRecord = (enqId) => {
    axios
      .get(`https://arambam-server.onrender.com/enquiries/${enqId}`)
      .then((res) => {
  ...
  const updateEnq = (e) => {
    e.preventDefault();
    axios
      .put(`https://arambam-server.onrender.com/enquiries/${_id}`, {
        name,
        mobile,
        email,
        message,
  ...
  return (
    <div className="container p-5 view-enquiry">
      <h1 className="text-center mb-4 fs-2 fw-bold text-uppercase " style={{color:"#2E7D32",fontFamily:"Savate"}}>View Enquiries</h1>
      ...
      <div className="modal fade" id="update" data-bs-backdrop="static">
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            style={{ color: "#2E7D32" }}>Update Enquiry</h5>
